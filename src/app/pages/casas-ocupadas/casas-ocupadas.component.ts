...
import { geoJSON, Icon, Map, marker, polygon, polyline, tileLayer } from 'leaflet';
...
import { casasOcupadas } from '../../../assets/markers/casas-ocupadas';

import secionesCensales from '../../../assets/data/secionesCensalesUpdateCenso2004-2022UpdateTotal.json';

@Component({
	selector: 'app-casas-ocupadas',
	templateUrl: './casas-ocupadas.component.html',
	styleUrls: ['./casas-ocupadas.component.scss']
})
export class CasasOcupadasComponent implements AfterViewInit {
	constructor() {}

	ngAfterViewInit(): void {
		// http://leaflet-extras.github.io/leaflet-providers/preview/
		const mapProblemas = new Map('mapCasasOcupadas');
